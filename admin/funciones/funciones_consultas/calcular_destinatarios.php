...
$result_padres=$link->query("select matriculas.userid, 
					...
					where parentescos.alumno = matriculas.userid and matriculas.nivelid = '$id_nivel' and matriculas.ano = $matricula_vigente GROUP BY parentescos.apoderado ") or die (mysql_error());
