<?php
function crear_thumb($imagen,$altura,$direct_thum,$prefijo) { 
     ...
     if (!file_exists($camino.$dir_thumb.$prefijo_thumb.$nombre)) { 
          ...
          // voil� la salvamos con el nombre y en el lugar que nos interesa. 
		 						...
		 						if($extension=='.jpg' || $extension=='jpeg')
								{
									...
									if(!imagepng($thumb,$camino.$dir_thumb.$prefijo_thumb.$nombre)){ echo 'No se pudo crear THUMB';}
								//imagepng($thumb,$camino.$dir_thumb.$prefijo_thumb.$nombre); 
								}elseif($extension==".gif"){
									if(!imagegif($thumb,$camino.$dir_thumb.$prefijo_thumb.$nombre)){ echo 'No se pudo crear THUMB';}
								//imagegif($thumb,$camino.$dir_thumb.$prefijo_thumb.$nombre);
								}elseif ($extension==".bmp"){  
									if(!imagewbmp($thumb,$camino.$dir_thumb.$prefijo_thumb.$nombre)){ echo 'No se pudo crear THUMB';}
